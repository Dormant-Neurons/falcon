...
def parse_args():
    ...
    p.add_argument('--index', type=int, default=None,
               help='Split index within selected samples: '
                    '[0:index) are treated as uncertain (relabeled via oracle), '
                    '[index:] are treated as certain (no relabel, use model prediction).')
